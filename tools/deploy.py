...
def main():
    ...
    if len(sys.argv) < 4:
        ...
        print()
        print("Examples:")
        print("  deploy.py baseline-repave --bom boms/baseline.yaml")
        print("  deploy.py functional-release --bom boms/functional.yaml")
        print("  deploy.py rollback --bom boms/functional.yaml")
        print()
